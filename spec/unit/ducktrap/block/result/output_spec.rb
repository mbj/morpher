...
describe Ducktrap::Block::Result, '#output' do
  ...
  context 'with body' do
    ...
    context 'with late failure' do
      ...
      it { should eql(Ducktrap::Block::BlockMemberError.new(context, input_b, result_b.error)) }
    ...
    context 'with early failure' do
      ...
      it { should eql(Ducktrap::Block::BlockMemberError.new(context, input_a, result_a.error)) }
