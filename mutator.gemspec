...
require File.expand_path('../lib/mutator/version.rb', __FILE__)

Gem::Specification.new do |gem|
  gem.name        = 'mutator'
  gem.version     = Mutator::VERSION.dup
  gem.authors     = [ 'Markus Schirp' ]
  gem.email       = [ 'mbj@seonic.net' ]
  gem.description = 'Invertable mutations on data structures'
  gem.summary     = gem.description
  gem.homepage    = 'https://github.com/mbj/mutator'
